...
class BoostServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(TaskService::class, function (): TaskService {
            $config = new Config;
            $service = new TaskService;
            $service->setMaxTasks($config->getFuelMaxTasks());
    ...
    protected function registerCommands(): void
    {
        if ($this->app->runningInConsole()) {
            $this->commands([
                ...
                Console\Fuel\AddCommand::class,
                Console\Fuel\ListCommand::class,
                Console\Fuel\ReadyCommand::class,
                Console\Fuel\DoneCommand::class,
                Console\Fuel\PruneCommand::class,
                Console\Fuel\KanbanCommand::class,
            ]);
        }
    }
