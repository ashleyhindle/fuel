...
class Config
{
    ...
    public function setFuel(bool $enabled): void
    {
        $this->set('fuel', $enabled);
    }

    public function getFuel(): bool
    {
        return $this->get('fuel', false);
    }

    public function setFuelMaxTasks(int $maxTasks): void
    {
        $this->set('fuel_max_tasks', $maxTasks);
    }

    public function getFuelMaxTasks(): int
    {
        return (int) $this->get('fuel_max_tasks', 50);
    }
