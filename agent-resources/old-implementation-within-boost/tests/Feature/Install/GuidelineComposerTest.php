...
test('includes fuel guidelines when usesFuel is true', function (): void {
    $packages = new PackageCollection([
        new Package(Packages::LARAVEL, 'laravel/framework', '11.0.0'),
    ]);
    ...
    expect($guidelines)
        ->toContain('=== fuel rules ===')
        ->toContain('Fuel Task Management')
        ->toContain('fuel:ready')
        ->toContain('fuel:done');
});

test('excludes fuel guidelines when usesFuel is false', function (): void {
    $packages = new PackageCollection([
        new Package(Packages::LARAVEL, 'laravel/framework', '11.0.0'),
    ]);
    ...
    expect($guidelines)
        ->not->toContain('=== fuel rules ===')
        ->not->toContain('Fuel Task Management');
});
