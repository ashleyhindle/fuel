...
class BrowserCloseCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            // Send BrowserClose command with request ID
            $requestId = app(\App\Services\ConsumeIpcProtocol::class)->generateRequestId();

            $command = new BrowserCloseIpcCommand(
                contextId: $contextId,
            ...
            if ($this->option('json')) {
                ...
                $this->info("Browser context '{$contextId}' closed successfully");
