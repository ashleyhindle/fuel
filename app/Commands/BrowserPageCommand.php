...
class BrowserPageCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            // Send BrowserPage command with request ID
            $protocol = new \App\Services\ConsumeIpcProtocol;
            $requestId = $protocol->generateRequestId();

            $command = new BrowserPageIpcCommand(
                contextId: $contextId,
                pageId: $pageId,
            ...
            if ($this->option('json')) {
                ...
                $this->info("Page '{$pageId}' created in context '{$contextId}' successfully");
