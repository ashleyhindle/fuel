...
- [ ] `browser:click`, `browser:fill`, `browser:type` action commands
- [ ] `browser:text`, `browser:html` query commands
- [ ] `browser:wait` command for selector/URL/text
- [ ] Element ref support (daemon-side memory, resolve @e1 to locator)
